...
/** Circle arrow left */
object FA_CIRCLE_ARROW_LEFT: Icon {
	
	override val name get() = "Circle arrow left"
	
	override val unicode get() = "f0a8"
...
/** Alias for [FA_CIRCLE_ARROW_LEFT]. */
val FA_ARROW_CIRCLE_LEFT = FA_CIRCLE_ARROW_LEFT
