...
/** Square up right */
object FA_SQUARE_UP_RIGHT: Icon {
	
	override val name get() = "Square up right"
	
	override val unicode get() = "f360"
...
/** Alias for [FA_SQUARE_UP_RIGHT]. */
val FA_EXTERNAL_LINK_SQUARE_ALT = FA_SQUARE_UP_RIGHT
