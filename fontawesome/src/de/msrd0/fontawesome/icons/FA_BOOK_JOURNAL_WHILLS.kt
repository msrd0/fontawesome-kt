...
/** Book journal whills */
object FA_BOOK_JOURNAL_WHILLS: Icon {
	
	override val name get() = "Book journal whills"
	
	override val unicode get() = "f66a"
...
/** Alias for [FA_BOOK_JOURNAL_WHILLS]. */
val FA_JOURNAL_WHILLS = FA_BOOK_JOURNAL_WHILLS
