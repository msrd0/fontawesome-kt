...
object FA_CIRCLE_CHEVRON_RIGHT: Icon {
	
	override val name get() = "Circle chevron right"
	
	override val unicode get() = "f138"
...
/** Alias for [FA_CIRCLE_CHEVRON_RIGHT]. */
val FA_CHEVRON_CIRCLE_RIGHT = FA_CIRCLE_CHEVRON_RIGHT
